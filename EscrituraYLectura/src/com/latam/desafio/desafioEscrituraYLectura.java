...
public class desafioEscrituraYLectura {
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		String carpeta = "";
		String fichero = "";
		String ruta = ("src/com/latam/desafio/");
	...
	public static void buscarTexto(File archivo, String texto) {
		...
		try {
			...
			if (contador == 0) {
				...
				System.out.println("La palabra se repite " +contador+" veces en el fichero");
			}
